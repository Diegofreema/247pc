  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ gap: 10, marginTop: 20 }}>
        <Pressable onPress={onContactPress} style={styles.pressable}>
        ...
        <Pressable onPress={onEmailPress} style={styles.pressable}>
          <View style={styles.row}>
        ...
        <Pressable onPress={onOpenWhatsapp} style={styles.pressable}>
          <View style={styles.row}>
            <FontAwesome name={'whatsapp'} size={25} />
            <Text style={styles.text}>Chat us</Text>
          </View>
          <Entypo name="chevron-right" size={24} color="black" />
        </Pressable>
      </View>
